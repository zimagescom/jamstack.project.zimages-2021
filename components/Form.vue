<template>
    <div class="max-w-6xl m-auto text-black bg-gray-300 p-6 rounded-3xl shadow">
        ...
        <form name="jeu-concours" action="/pages/merci" method="post" data-netlify="true" data-netlify-honeypot="bot-field" enctype="multipart/form-data" class="max-w-3xl m-auto flex flex-col space-y-6">
