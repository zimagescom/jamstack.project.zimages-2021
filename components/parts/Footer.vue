<template>
    <div>
        <div class="relative">
            ...
            <address class="font-light leading-5">
                23 Avenue de Paris, 79000 Niort <br />
                Téléphone : <a href="tel:+330549248080"
                    class="hover:underline focus:outline-none focus:shadow-outline-purple">05 49 24 80 80</a><br />
